...
public class MainFeedListVideoAdapter extends ArrayAdapter<Video> {

    public interface OnLoadMoreVideoListener{
        void onLoadMoreVideos();
    }
    OnLoadMoreVideoListener mOnLoadMoreVideoListener;
    ...
    public MainFeedListVideoAdapter(@NonNull Context context, @LayoutRes int resource, @NonNull List<Video> objects,int act) {
    ...
    static class ViewHolder{
        ...
        ImageView image,heartRed, heartWhite,share,report,mFollow,mUnfollow;
    ...
    public View getView(final int position, @Nullable View convertView, @NonNull ViewGroup parent) {
        ...
        holder.share=(ImageView)convertView.findViewById(R.id.sharefeedvideo);
        holder.report=(ImageView)convertView.findViewById(R.id.reportfeedvideo);
       ...
       /*     convertView.setTag(holder);
            ...
            holder.mFollow.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    FirebaseDatabase.getInstance().getReference()
                            ...
                            .setValue(holder.video.getUser_id());
                    ...
                    new SendNotification().sendNotification("New Follower",currentUsername+" started following you."
                            ,holder.video.getUser_id(),null,null,mContext);
        ...
        imageLoader.displayImage(getItem(position).getThumbnail(), holder.image);
        ...
        holder.mPlay.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                if(act==0)
                {
                    ...
                    ((homeactivity)mContext).onVideoThreadSelected(getItem(position),
                            mContext.getString(R.string.home_activity));
                }
                else if(act==1)
                {
                    ((TrendingActivity)mContext).hideLayout();
                    ((TrendingActivity)mContext).onVideoThreadSelected(getItem(position),
        ...
        holder.share.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                String sharelinktext  = "https://kalaathon.page.link/?"+
                        "link=https://www.kalaathon.com/"+holder.video.getVideo_id()+"/"+holder.video.getUser_id()+"2"+
    ...
    private void loadMoreData(){
        ...
        try{
            mOnLoadMoreVideoListener = (OnLoadMoreVideoListener) getContext();
        }catch (ClassCastException e){

        }

        try{
            mOnLoadMoreVideoListener.onLoadMoreVideos();
        }catch (Exception e){
    ...
    private class MyAsyncTask extends AsyncTask<Void, Void, Void> {
        ...
        protected Void doInBackground(Void... voids) {
            ...
            try {
                if(act==0)
                {
                    if(add==1 && !holder.video.getUser_id().equals(FirebaseAuth.getInstance().getCurrentUser().getUid()))
                        ((homeactivity)mContext).notification(currentUsername,holder.user.getUser_id(),holder.video.getVideo_id(),"2");

                    old = new SimpleDateFormat("yyyy-MM-dd_HH:mm:ss").parse(holder.video.getDate_created());
                    ...
                    if(add==1 && !holder.video.getUser_id().equals(FirebaseAuth.getInstance().getCurrentUser().getUid()))
                        ((TrendingActivity)mContext).notification(currentUsername,holder.user.getUser_id(),holder.video.getVideo_id(),"2");
        ...
        try {
            if (mContext!=null) {
                ...
                Query query = reference.child(mContext.getString(R.string.dbname_following))
                        .child(currentuser)
                        .orderByChild(mContext.getString(R.string.field_user_id)).equalTo(holder.video.getUser_id());
                query.addListenerForSingleValueEvent(new ValueEventListener() {
                    @Override
                    public void onDataChange(DataSnapshot dataSnapshot) {
                        for (DataSnapshot singleSnapshot : dataSnapshot.getChildren()) {
